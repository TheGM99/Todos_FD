...
// configuration ===============================================================
mongoose.connect("mongodb+srv://mateusz_stelmasiak:Pudzian123@frontend.a3ezm.mongodb.net/?retryWrites=true&w=majority", {
...
app.patch("/api/todos/:_id", function (req, res) {
